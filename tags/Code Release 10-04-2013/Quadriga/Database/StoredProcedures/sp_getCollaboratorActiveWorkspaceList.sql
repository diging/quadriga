/*******************************************
Name          : sp_getCollaboratorActiveWorkspaceList

Description   : Retrieves the active workspace list for which 
...
********************************************/
DROP PROCEDURE IF EXISTS sp_getCollaboratorActiveWorkspaceList;
DELIMITER $$
...
BEGIN
      ...
      END IF;
       ...
       -- fetch the workspace for which the user is collaborator
