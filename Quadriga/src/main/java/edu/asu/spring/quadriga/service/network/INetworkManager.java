...
public interface INetworkManager {
    ...
    /**
     * Get {@link IProject} ID of type {@link String} for {@link IWorkspace} ID
     * of type {@link String}. As we have {@link INetwork} attached to a
     * {@link Workspace}. We need {@link IProject} ID to display to which
     * project the network belongs to.
     * 
     * @param workspaceid
    ...
    /**
     * This method shoud help in Unmarshalling XML {@link String} into
     * {@link ElementEventsType} object.
     * 
     * @param xml
     *            XML in the form of {@link String}
     * @return Returns the {@link ElementEventsType} object for a particular
     *         QStore XML
     * @throws JAXBException
     *             Throws JAXB exception in case we have issues while
     *             unmarshalling.
     */
    public abstract ElementEventsType unMarshalXmlToElementEventsType(String xml) throws JAXBException;

    /**
     * This method should help in parsing a {@link RelationEventType} object to
     * get the details of the {@link RelationEventObject}. It could fetch
     * information of the {@link PredicateObject} , {@link SubjectObject},
     * {@link ObjectTypeObject} of the {@link RelationEventObject}
     * 
     * @param relationEventType
     *            {@link RelationEventType} object
     * @param relationEventObject
     *            {@link RelationEventObject} object
     ...
     *            network.
     * @return Returns the {@link RelationEventObject} object with parsed
     *         details.
     */
    public abstract RelationEventObject parseThroughRelationEvent(RelationEventType relationEventType,
            RelationEventObject relationEventObject, List<List<Object>> relationEventPredicateMapping);

    /**
     * This method should help in parsing through the {@link PredicateType} of a
     * particular {@link RelationEventType}. We could parse the
     * {@link PredicateType} object for any required variables or objects in it.
     * 
     * @param relationEventType
     *            Target {@link RelationEventType} object
     * @param predicateType
     *            Target {@link PredicateType} object
     * @param relationEventPredicateMapping
     *            {@link List} of {@link List} of {@link Object} to hold
     *            {@link PredicateObject} in it to avoid redundancy in the
     *            network.
    ...
    public abstract PredicateObject parseThroughPredicate(RelationEventType relationEventType,
            PredicateType predicateType, List<List<Object>> relationEventPredicateMapping);
    ...
    /**
     * This method should help in parsing through the {@link SubjectObjectType}
     * of a particular {@link RelationEventType} for SubjectType of Relation. We
     * could parse the {@link SubjectObjectType} object for any required
     * variables or objects in it.
     * 
     * @param relationEventType
     *            Target {@link RelationEventType} object
     * @param subjectObjectType
     *            Target {@link SubjectObjectType} object
     * @param relationEventPredicateMapping
     *            {@link List} of {@link List} of {@link Object} to hold
     *            {@link PredicateObject} in it to avoid redundancy in the
     *            network.
    ...
    public abstract SubjectObject parseThroughSubject(RelationEventType relationEventType,
            SubjectObjectType subjectObjectType, List<List<Object>> relationEventPredicateMapping);

    /**
     * This method should help in parsing through the {@link SubjectObjectType}
     * of a particular {@link RelationEventType} for ObjectType of Relation.
     * 
     * @param relationEventType
     *            Target {@link RelationEventType} object
     * @param subjectObjectType
    ...
    public abstract String storeText(String xml, String projectid, String workspaceid) throws NetworkXMLParseException, QuadrigaStorageException, IOException;
