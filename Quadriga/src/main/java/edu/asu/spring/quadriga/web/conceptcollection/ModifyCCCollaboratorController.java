...
public class ModifyCCCollaboratorController {
    ...
    protected void initBinder(HttpServletRequest request,
        ...
        binder.registerCustomEditor(List.class,
                "collaborators.collaboratorRoles", new PropertyEditorSupport() {
    ...
    public ModelAndView updateCollaboratorForm(
            @PathVariable("collectionid") String collectionid,
            Principal principal) throws QuadrigaStorageException,
            QuadrigaAccessException {
        ModelAndView model = new ModelAndView(
                "auth/conceptcollection/updatecollaborators");
        ...
        ModifyCollaboratorForm collaboratorForm = collaboratorFactory
    ...
    public ModelAndView updateCollaboratorForm(
        ...
        if (result.hasErrors()) {
            ...
            ccCollaborators = collaboratorFormManager
                    .modifyCCCollaboratorManager(collectionid);
            ...
            for (ModifyCollaborator collab : ccCollaborators) {
                ...
                if (!collabUser.isEmpty()) {
                    collaboratorManager.updateCollaborators(collectionid,
                            collabUser, collabRoles.toString().substring(1),
                            principal.getName());
                }
