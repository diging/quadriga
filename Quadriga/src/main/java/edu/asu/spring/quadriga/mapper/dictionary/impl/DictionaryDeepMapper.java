...
public class DictionaryDeepMapper implements IDictionaryDeepMapper {
     ...
     */
    @Override
    public IDictionary getDictionary(DictionaryDTO dictionaryDTO) throws QuadrigaStorageException {
        ...
        dictionary.setProjects(
                projectDictionaryShallowMapper.getProjectDictionaryList(dictionaryDTO, dictionary));
        // Setting dictionary Workspaces
        dictionary.setWorkspaces(
                workspaceDictionaryShallowMapper.getWorkspaces(dictionary, dictionaryDTO));
        // Setting dictionary Items
        dictionary.setDictionaryItems(getDictionaryItems(dictionaryDTO, dictionary));

        return dictionary;
    }

    public List<IDictionaryItems> getDictionaryItems(DictionaryDTO dictionaryDTO, IDictionary dictionary) {
