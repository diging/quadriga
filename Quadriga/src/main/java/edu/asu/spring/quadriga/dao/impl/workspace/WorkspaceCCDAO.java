...
public class WorkspaceCCDAO extends BaseDAO<WorkspaceConceptcollectionDTO> implements IWorkspaceCCDAO {
    ...
    // List<IConceptCollection> conceptCollList = new
    // ArrayList<IConceptCollection>();
    // try
    // {
    // WorkspaceDTO workspace = (WorkspaceDTO)
    // sessionFactory.getCurrentSession().get(WorkspaceDTO.class, workspaceId);
    // if(workspace == null)
    // {
    // return null;
    // }
    // List<WorkspaceConceptcollectionDTO> workspaceConceptCollection =
    // workspace.getWorkspaceConceptCollectionDTOList();
    //
    ...
    // }
    //
    // for(WorkspaceConceptcollectionDTO tempWSConceptCollection :
    // workspaceConceptCollection)
    // {
    // ConceptCollectionDTO conceptCollectionDTO =
    // tempWSConceptCollection.getConceptCollectionDTO();
    // IConceptCollection conceptCollection =
    // collectionMapper.getConceptCollection(conceptCollectionDTO);
