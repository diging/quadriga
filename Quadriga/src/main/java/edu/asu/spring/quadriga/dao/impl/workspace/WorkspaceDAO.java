...
public class WorkspaceDAO extends BaseDAO<WorkspaceDTO> implements IWorkspaceDAO {
     ...
     * {@link ProjectWorkspaceDTO} mapping object is deleted from the list
     * of workspaces of a project, then the object is deleted. Last, the object
     * is set to null on the respective workspace.
     * 
     * @param wsDTO The workspace DTO for which the mapping objects should be deleted.
     */
     ...
     * mapping objects ({@link WorkspaceConceptcollectionDTO}) are removed from the respective concept collections, then the
     * mapping objects are deleted. Last, the variable in the workspace object is set
     * to null.
     * @param wsDTO Workspace for which the mapping objects should be deleted.
     */
    private void deleteWorkspaceConceptCollectionMappings(WorkspaceDTO wsDTO) {
        ...
        List<WorkspaceConceptcollectionDTO> workspaceConceptCollectionList = wsDTO.getWorkspaceConceptCollectionDTOList();
    ...
    /**
     * Method to delete workspace-dictionary mapping objects ({@link WorkspaceDictionaryDTO}).
     * First the mapping objects are removed from the respective Dictionaries, then the 
     * mapping objects are deleted. Last the reference to the mapping objects in the workspace
     * object is set to  null.
     * 
     * @param wsDTO The workspace DTO ({@link WorkspaceDTO}) for which the 
     * mapping objects should be deleted.
     */
    ...
    /**
     * Method to delete workspace-DSpace mapping objects ({@link WorkspaceDspaceDTO}).
     * First the mapping objects are deleted. Then the reference to the mapping objects 
     * in the workspace object is set to  null.
     * 
     * @param wsDTO The workspace DTO ({@link WorkspaceDTO}) for which the 
     * mapping objects should be deleted.
     */
    ...
    /**
     * Method to delete workspace-editor mapping objects ({@link WorkspaceEditorDTO}).
     * First the mapping objects are deleted. Then the reference to the mapping objects 
     * in the workspace object is set to  null.
     * 
     * @param wsDTO The workspace DTO ({@link WorkspaceDTO}) for which the 
    ...
    /**
     * Method to delete workspace-network mapping objects ({@link NetworkWorkspaceDTO}).
     * First the mapping objects are deleted. Then the reference to the mapping objects 
     * in the workspace object is set to  null.
     * 
     * @param wsDTO The workspace DTO ({@link WorkspaceDTO}) for which the 
