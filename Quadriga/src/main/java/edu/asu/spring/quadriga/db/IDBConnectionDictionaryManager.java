...
public interface IDBConnectionDictionaryManager {
	 ...
	 */
	public abstract List<IDictionary> getDictionaryOfUser(String userName) throws QuadrigaStorageException;
	/**
	 ...
	 * @throws QuadrigaStorageException 
	 */
	public abstract String addDictionary(IDictionary dictionary) throws QuadrigaStorageException;
	/**
	 ...
	 * @throws QuadrigaStorageException 
	 */
	public abstract List<IDictionaryItems> getDictionaryItemsDetails(String dictionaryid) throws QuadrigaStorageException;
	/**
	...
	public String addDictionaryItems(String dictinaryId, String item, String id,
			String pos, String owner) throws QuadrigaStorageException;
	/**
	 ...
	 * @throws QuadrigaStorageException 
	 */
	public abstract String  deleteDictionaryItems(String dictinaryId, String itemid) throws QuadrigaStorageException;
	/**
	 ...
	 * @throws QuadrigaStorageException 
	 */
	public abstract String updateDictionaryItems(String dictinaryId,String termid,String term ,String pos) throws QuadrigaStorageException;
}
