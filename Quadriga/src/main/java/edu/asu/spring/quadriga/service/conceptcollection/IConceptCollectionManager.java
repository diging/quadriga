...
public interface IConceptCollectionManager {
     ...
     */
    void addItems(String lemmma, String id, String pos, String desc, String conceptcollectionId, String string)
     ...
     * @throws QuadrigaStorageException
     */
    public abstract void update(String[] values, IConceptCollection concept, String username)
            throws QuadrigaStorageException;

    public abstract List<IConceptCollectionCollaborator> showCollaboratingUsers(String collectionid)
            throws QuadrigaStorageException;
