...
public class ProjectStats implements IProjectStats {
    ...
    private IUserStats retrieveUserWorkspaceStats(String projectId, String username) throws QuadrigaStorageException {
        List<IWorkSpace> workspaceList = listWSDAO.listWorkspace(projectId, username);
        UserStats userStats;
