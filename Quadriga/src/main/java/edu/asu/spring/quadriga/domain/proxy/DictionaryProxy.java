...
/**
 * Dictionary class describing the properties of a Dictionary object
 * 
...
public class DictionaryProxy implements IDictionary {
    ...
    private void setDictionaryDetails() {
        try {
            ...
            logger.error("Couldn't fill dictionary.", e);
            return;
        }
    ...
    public List<IProject> getProjects() {
        ...
        return this.dictionary.getProjects();
    }
    ...
    public void setProjects(List<IProject> projects) {
        ...
        this.dictionary.setProjects(projects);
    ...
    public List<IWorkspace> getWorkspaces() {
        ...
        return this.dictionary.getWorkspaces();
    ...
    public void setWorkspaces(List<IWorkspace> workspaces) {
        ...
        this.dictionary.setWorkspaces(workspaces);
