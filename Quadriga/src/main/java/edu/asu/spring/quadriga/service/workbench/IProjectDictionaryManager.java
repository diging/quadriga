...
public interface IProjectDictionaryManager {
	 ...
	 */
	public void addDictionaryToProject(String projectId, String dictionaryId, String userId)throws QuadrigaStorageException;
	
	/**
	 * This class helps in getting {@link List} the {@link IProjectDictionary} from {@link IProject} and {@link IUser} Id
	 * @param projectId								{@link IProject} ID of type {@link String} 
	 * @param userId								{@link IUser} ID of type {@link String}							
