package edu.asu.spring.quadriga.aspects.access.tokens.impl;
...
import edu.asu.spring.quadriga.aspects.access.github.GitHubTemplateFactory;
import edu.asu.spring.quadriga.aspects.access.openid.google.CheckerResult;
import edu.asu.spring.quadriga.aspects.access.openid.google.ValidationResult;
import edu.asu.spring.quadriga.aspects.access.tokens.IChecker;
...
import edu.asu.spring.quadriga.web.tokens.impl.ApiTokenContents;
