...
/**
 * This class acts a proxy to {@link Project} while fetching {@link List} of {@link IProject}. 
 * {@link ProjectProxy} would load the {@link List} of associated using lazy load concept.
 *  
...
public class ProjectProxy implements IProject 
{
	...
	/**
	 *  Access to {@link IRetrieveProjectManager} to call manager methods to update actual {@link Project} object.
	 */
	private IRetrieveProjectManager projectManager;
	
	private static final Logger logger = LoggerFactory
			.getLogger(ProjectProxy.class);
	 ...
	 * @param projectManager					{@link IRetrieveProjectManager} object to get access to project manager layer 
	 */
	...
	/**
	 * {@inheritDoc}
	 * Also updates the local {@link IProject} object if it is not null
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * This method checks if local {@link IProject} object is null. 
	 * If its null it would use project manager object to fetch full project object and then return {@link List} of {@link IProjectCollaborator}
	...
	/**
	 * {@inheritDoc}
	 * This method also checks if local {@link IProject} object is null. 
	 * If its null it would use manager object to fetch full project object and then set {@link List} of {@link IProjectCollaborator}
	 * else if local {@link IProject} is not null, just set {@link List} of {@link IProjectCollaborator}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * This method checks if local {@link IProject} object is null. 
	 * If its null it would use project manager object to fetch full project object and then return {@link List} of {@link IProjectWorkspace}
	 * else if local {@link IProject} is not null, just returns {@link List} of {@link IProjectWorkspace} from local {@link IProject}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * This method also checks if local {@link IProject} object is null. 
	 * If its null it would use manager object to fetch full project object and then set {@link List} of {@link IProjectWorkspace}
	 * else if local {@link IProject} is not null, just set {@link List} of {@link IProjectWorkspace}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * This method checks if local {@link IProject} object is null. 
	 * If its null it would use project manager object to fetch full project object and then return {@link List} of {@link IProjectDictionary}
	 * else if local {@link IProject} is not null, just returns {@link List} of {@link IProjectDictionary} from local {@link IProject}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * This method also checks if local {@link IProject} object is null. 
	 * If its null it would use manager object to fetch full project object and then set {@link List} of {@link IProjectDictionary}
	 * else if local {@link IProject} is not null, just set {@link List} of {@link IProjectDictionary}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * This method checks if local {@link IProject} object is null. 
	 * If its null it would use project manager object to fetch full project object and then return {@link List} of {@link IProjectConceptCollection}
	 * else if local {@link IProject} is not null, just returns {@link List} of {@link IProjectConceptCollection} from local {@link IProject}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * This method also checks if local {@link IProject} object is null. 
	 * If its null it would use project manager object to fetch full project object and then set {@link List} of {@link IProjectConceptCollection}
	 * else if local {@link IProject} is not null, just set {@link List} of {@link IProjectConceptCollection}
	 * 
	 */
	@Override
