...
public class WorkspaceCCManager implements IWorkspaceCCManager {
    ...
    @Override
    @Transactional
    public List<IConceptCollection> getConceptCollections(String workspaceId) throws QuadrigaStorageException {
        WorkspaceDTO workspaceDTO = wsDAO.getDTO(workspaceId);
        IWorkspace workspace = wsDeepMapper.mapWorkspaceDTO(workspaceDTO);
        List<IConceptCollection> wsCCList = wsCCShallowMapper.getConceptCollections(workspace, workspaceDTO);
        return wsCCList;
    }

    @Override
    @Transactional
    public List<IConceptCollection> getNotAssociatedConceptCollectins(String workspaceId)
