package edu.asu.spring.quadriga.mapper.conceptcollection.impl;
...
@Service
public class ConceptCollectionDeepMapper implements IConceptCollectionDeepMapper {
    @Autowired
    ...
    @Override
    @Transactional
    public IConceptCollection getConceptCollectionDetails(String ccId) throws QuadrigaStorageException {
     ...
     */
    @Override
    public void fillConceptCollection(IConceptCollection conceptCollection, ConceptCollectionDTO ccDTO)
            throws QuadrigaStorageException {
        ...
        conceptCollection
                .setConceptCollectionCollaborators(getConceptCollectionCollaboratorList(ccDTO, conceptCollection));
        // Setting dictionary Projects
        conceptCollection.setProjects(projectCCShallowMapper.getProjectConceptCollectionList(ccDTO, conceptCollection));
        // Setting dictionary Workspaces
        conceptCollection.setWorkspaces(workspaceCCShallowMapper.getWorkspaces(conceptCollection, ccDTO));
        // Setting dictionary Items
        conceptCollection.setConcepts(getConcepts(ccDTO, conceptCollection));
    }

    public List<IConceptCollectionCollaborator> getConceptCollectionCollaboratorList(ConceptCollectionDTO ccDTO,
        ...
        if (ccDTO.getConceptCollectionCollaboratorDTOList() != null
            ...
            HashMap<String, IConceptCollectionCollaborator> userCCCollaboratorMap = mapUserCCCollaborator(ccDTO,
                    conceptCollection);
    ...
    public HashMap<String, IConceptCollectionCollaborator> mapUserCCCollaborator(ConceptCollectionDTO ccDTO,
            IConceptCollection conceptCollection) throws QuadrigaStorageException {
        ...
        for (ConceptCollectionCollaboratorDTO ccCollaboratorDTO : ccDTO.getConceptCollectionCollaboratorDTOList()) {
            ...
            if (userCCCollaboratorMap.containsKey(userName)) {
                ...
                IQuadrigaRole collaboratorRole = roleManager
                        .getQuadrigaRoleByDbId(IQuadrigaRoleManager.CONCEPT_COLLECTION_ROLES, roleName);
    ...
    public List<IConcept> getConcepts(ConceptCollectionDTO conceptColelctionDTO,
