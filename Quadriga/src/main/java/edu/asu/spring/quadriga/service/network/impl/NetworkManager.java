...
public class NetworkManager extends BaseDAO<NetworksDTO> implements INetworkManager {
     ...
     */
    @Override
    public String storeXMLQStore(String XML) throws QStoreStorageException {
        String res = "";
    ...
    public String storeNetworkDetails(String xml, IUser user, String networkName, String workspaceId,
            String uploadStatus, String networkId, int version)
                    throws QuadrigaStorageException, QuadrigaAccessException, JAXBException {
        ElementEventsType elementEventType = unMarshalXmlToElementEventsType(xml);

        // Get Workspace details.
        IWorkSpace workspace = wsManager.getWorkspaceDetails(workspaceId, user.getUserName());
