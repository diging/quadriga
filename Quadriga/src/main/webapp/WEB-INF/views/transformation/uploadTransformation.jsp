...
<div class="form-group required">
<div class="col-md-12"><input type="file" class="form-control"  required="required"></div>
</div>
...
<div class="col-md-8"><input type="text" class="form-control" id="transformTitle" required="required"></div>
</div>
	
<div class="form-group">
<label for="transfomrDesciption" class="col-md-4 control-label" style="font-weight:bold;">Description </label>
<div class="col-md-8"> <textarea class="form-control" rows="2" id="transfomrDescription" placeholder="This field is optional"></textarea></div>
</div>
