...
<div id="features">
	<div class="container">
		<div class="row">
						...
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									${latestProjects[0].projectName} </a>
							</div>
								...
								<div class="accordion-inner">
									<p>${latestProjects[0].description}
										...
										<a style="font-size: 16px;"
											href="${pageContext.servletContext.contextPath}/sites/${latestProjects[0].unixName}">Explore
											project...</a>
									</p>
								</div>
								<!-- /accordion-inner -->
						...
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									${latestProjects[1].projectName} </a>
							</div>
							<div id="collapseTwo" class="accordion-body collapse">
								<div class="accordion-inner">
									<p>${latestProjects[1].description}
										<br>
										<a style="font-size: 16px;"
											href="${pageContext.servletContext.contextPath}/sites/${latestProjects[1].unixName}">Explore
											project...</a>
									</p>
								</div>
								<!-- /accordion-inner -->
						...
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									${latestProjects[2].projectName} </a>
							</div>
							<div id="collapseThree" class="accordion-body collapse">
								<div class="accordion-inner">
									<p>${latestProjects[2].description}
										<br>
										<a style="font-size: 16px;"
											href="${pageContext.servletContext.contextPath}/sites/${latestProjects[2].unixName}">Explore
											project...</a>
									</p>
								</div>
								<!-- /accordion-inner -->
					...
					<div class="accordion-group">
						<div class="accordion-heading">
							<a class="accordion-toggle" data-toggle="collapse"
								...
								${latestProjects[3].projectName} </a>
						</div>
						<div id="collapseFour" class="accordion-body collapse">
							<div class="accordion-inner">
								<p>
									${latestProjects[3].description} <br>
									<a style="font-size: 16px;"
										href="${pageContext.servletContext.contextPath}/sites/${latestProjects[3].unixName}">Explore
										project...</a>
								</p>
							</div>
							<!-- /accordion-inner -->
			...
			<div class="centered" style="padding-bottom: 40px;">
				<a class="btn btn-primary"
					href="${pageContext.servletContext.contextPath}/sites/">See all
					Project</a>
			</div>
		...
		<div class="row">
			...
			<p>
				Quadruples contain references to the exact position in a text where
				a concept is used or where a statement is made. We can use this
				feature to implement search engines that do not use string
				comparison techniques to find texts of interest, but rather search
				for the actual concept or statement in a text that the user is
				interested. To try out our prototype for such a search, head over to
				our <a href="${pageContext.servletContext.contextPath}/search/texts"><i
					class="fa fa-search" aria-hidden="true"></i> text search interface</a>.
