...
<li><a class="fa fa-user" href="/quadriga/j_spring_security_logout" style=" margin:2px 10px; padding:0px 0px 0px 0px; font-size:80% ">${project.owner.name} <br> &nbsp Logout</a>
