		...
		<table style="width: 100%">
			...
			<tr>
				<td>Public URL:
				    ...
				    <form:input path="unixName" id="unixName" type="hidden"/>
				    <form:input path="projectAccess" id="projectAccess" type="hidden"/>
...
>>>>>>> branch 'story-QUAD-5' of https://github.com/diging/quadriga.git
</article>
